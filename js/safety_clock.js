...
class SafetyClockGauge {
  ...
  drawDial() {
    ...
    ctx.shadowColor = isDark ? 'rgba(255, 255, 255, 0.8)' : 'rgba(15, 23, 42, 0.3)';
    ctx.stroke();
    ctx.shadowBlur = 0;
  ...
  drawSigmoidCurve() {
    ...
    ctx.strokeStyle = isDark ? 'rgba(0, 240, 255, 0.8)' : '#0284c7';
    ctx.lineWidth = 2.2;
    ctx.shadowBlur = isDark ? 8 : 2;
    ctx.shadowColor = isDark ? 'rgba(0, 240, 255, 0.5)' : 'rgba(2, 132, 199, 0.2)';
    ctx.stroke();
    ctx.shadowBlur = 0;
